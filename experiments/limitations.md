...
## ❌ Table 2 — Pretraining and Instruction-Tuning Dataset Details
...
## ❌ Table 6 — Full Vision-Language Benchmark Comparisons
...
## ❌ Table 7 — Image Corruption Robustness
...
## ❌ Table 10 — Generalization Across Diverse Benchmarks
...
## ❌ Table 11 — Multimodal Reasoning and Alignment Evaluation
...
This replication focuses on what can be measured locally using:

- The **FastVLM Stage-3 checkpoint**
- Available datasets (TextVQA, DocVQA, GQA)
- Hardware constraints (RTX 4070 8GB)

The remaining tables require:

- External VLMs not publicly released
- Proprietary datasets
- Full pretraining and instruction tuning pipelines
- Benchmarking infrastructure used in the original paper

Therefore, only a subset of experimental results can be reproduced.

...
def get_benchmark_dataset(benchmark_name: str = "textvqa",
    ...
    try:
        ...
        print(f"✅ Successfully loaded {len(formatted_data)} samples from {benchmark_name}")
        return formatted_data

    except Exception as e:
        print(f"❌ Error loading dataset: {e}")
        print("Falling back to local dummy mode if needed, or check internet connection.")
        return []

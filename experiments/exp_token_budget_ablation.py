...
def measure_inference_with_ttft(model, tokenizer, processor, image: Image.Image,
...
def run_token_budget_experiment(model_path: str, image_folder: str, prompt: str,
    ...
    ref_result = measure_inference_with_ttft(model, tokenizer, processor, ref_image, prompt, device)

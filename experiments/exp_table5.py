...
def build_table5() -> List[Dict[str, Any]]:
    ...
    # If TextVQA specifically is empty, keep old safety check behavior
    ...
    for res in RESOLUTIONS:
        ...
        sqa_res = {"accuracy": None, "avg_latency_ms": None}
        textvqa_res = {"accuracy": None, "avg_latency_ms": None}
        pope_res = {"accuracy": None, "avg_latency_ms": None}
        seedbench_res = {"accuracy": None, "avg_latency_ms": None}

        if benchmark_samples["sqa"]:
            print("\n[SQA]")
        ...
        if benchmark_samples["seedbench"]:
            print("\n[SeedBench]")
        ...
        rows.append({
            ...
            "sqa_acc": sqa_res["accuracy"],
            "textvqa_acc": textvqa_res["accuracy"],
            "pope_acc": pope_res["accuracy"],
            "seedbench_acc": seedbench_res["accuracy"],
            # keep one latency field (e.g., from TextVQA) for logging/analysis
            "avg_latency_ms": textvqa_res["avg_latency_ms"],
        })
